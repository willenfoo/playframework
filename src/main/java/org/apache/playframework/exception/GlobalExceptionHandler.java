...
public class GlobalExceptionHandler {
    ...
    public R<Object> handleBadRequest(HandlerMethod handlerMethod, Exception e) {
        ...
        if(genericReturnType instanceof ParameterizedType){
            ...
            for (Type type : actualTypeArguments) {
                if (type instanceof ParameterizedTypeImpl) {
                    ...
                    if (parameterizedType.getRawType().getName().equals(List.class.getName())) {
        ...
        if (e instanceof ApiException) {
            ...
            if (null != errorCode) {
                logger.info("Rest request error, {}", errorCode.toString());
                return R.restResult(resultData, errorCode);
            }
            logger.info("Rest request error, {}", e.getMessage());
            return R.restResult(resultData, ApiErrorCode.FAILED);
        }
