package org.apache.playframework.mybatisplus;
...
public class IllegalSQLIndexInterceptor implements Interceptor {

	private static final Map<String, TableInfo> tableInfoMap = new ConcurrentHashMap<>();
	 
    private static final Log logger = LogFactory.getLog(IllegalSQLIndexInterceptor.class);
