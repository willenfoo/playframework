        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new InjectionConfig() {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        return "D:/develop/" + tableInfo.getEntityName() + ".xml";
                    }
                }))
        ).setTemplate(
                ...
                // .setXml("...");
                // .setService("...");
                .setServiceImpl("D:/git_repo/playframework/src/main/java/org/apache/playframework/generator/template/serviceImpl.java")
        );
        // 执行生成
        if (1 == result) {
